...
- **Connections** - Reusable runtime profiles for GitHub Copilot or AI Platform, Jira, Confluence, GitHub, AWS, Jenkins, Nexus, Splunk, AppDynamics, PostgreSQL, BrowserStack, proxy, and Git identity
...
- **Nexus**, **Splunk**, **AppDynamics**, and **PostgreSQL** - Read-only troubleshooting instances (artifact lookups, log searches, application health, schema and query inspection), addressed by name with `--instance`

...
def upgrade() -> None:
    ...
    op.create_index("ix_agents_capability_profile_id", "agents", ["capability_profile_id"])
    op.create_index("ix_agents_policy_profile_id", "agents", ["policy_profile_id"])
    ...
    op.create_index("ix_agent_delegations_group_id", "agent_delegations", ["group_id"])
    op.create_index("ix_agent_delegations_parent_agent_id", "agent_delegations", ["parent_agent_id"])
    op.create_index("ix_agent_delegations_leader_agent_id", "agent_delegations", ["leader_agent_id"])
    op.create_index("ix_agent_delegations_assignee_agent_id", "agent_delegations", ["assignee_agent_id"])
    op.create_index("ix_agent_delegations_agent_task_id", "agent_delegations", ["agent_task_id"])
    op.create_index("ix_agent_delegations_leader_session_id", "agent_delegations", ["leader_session_id"])
    op.create_index("ix_agent_delegation_group_status", "agent_delegations", ["group_id", "status"])
    op.create_index("ix_agent_delegation_leader", "agent_delegations", ["leader_agent_id"])
    op.create_index("ix_agent_delegation_assignee", "agent_delegations", ["assignee_agent_id"])
    op.create_index("ix_agent_delegation_task", "agent_delegations", ["agent_task_id"])

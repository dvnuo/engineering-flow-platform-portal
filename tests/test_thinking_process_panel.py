...
def test_thinking_process_view_maps_opencode_runtime_event_severities():
    ...
    event_cases = [
        ...
        ("portal.reconcile.failed", {"error": "sync failed"}, "error", "error", "Reconcile Failed"),
        ("assistant.message.updated", {}, "running", "running", "Assistant Message Updated"),
        ("assistant.message.completed", {}, "success", "success", "Assistant Message Completed"),

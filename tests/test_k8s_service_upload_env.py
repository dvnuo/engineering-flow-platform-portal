...
class K8sServiceUploadEnvTest(unittest.TestCase):
    ...
    def test_both_runtimes_receive_the_chat_upload_contract(self):
        self.service.settings.chat_upload_extensions = "jpg,jpeg,png,webp,gif,pdf,docx,xlsx,csv,txt"
        ...
        for runtime_type in ("native", "opencode"):
            ...
            self.assertEqual(env["EFP_CHAT_UPLOAD_EXTENSIONS"], "jpg,jpeg,png,webp,gif,pdf,docx,xlsx,csv,txt", runtime_type)
    ...
    def test_garbage_settings_fall_back_to_the_defaults(self):
        ...
        self.assertEqual(env["EFP_CHAT_UPLOAD_EXTENSIONS"], "jpg,jpeg,png,webp,gif,pdf,docx,xlsx,csv,txt")

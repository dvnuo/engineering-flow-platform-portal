...
(function () {
  ...
  var HINTS = [
    ...
    ["#connector-nav-list .portal-connector-row", "Set up this connector for all your assistants"],
    ...
    ["#composer-model-select", "Model for this message only — the Model provider default is unchanged"],
    ...
    ['select[name="llm_max_context_tokens"]', "Largest context window your assistants may use by default"],
    ...
    ['input[name="confluence_enabled"]', "Let your assistants read and write Confluence"],
    ['input[name="github_enabled"]', "Let your assistants use the GitHub API"],
    ...
    ['[data-action="remove-instance"]', "Remove this row from the connector"],
    ...
    ['[data-instance-item="aws_accounts"] [data-field="regions"]', "Regions this account is used in; pick one or more. The first is the default for cluster commands."],
    ...
    ['[data-instance-item="aws_eks_clusters"] [data-field="account"]', "The AWS account this cluster belongs to, one of the rows above"],
    ...
    ['input[name="nexus_enabled"]', "Let your assistants look up artifacts in Nexus (read-only)"],
    ...
    ['input[name="splunk_enabled"]', "Let your assistants run Splunk searches (read-only, always time-bounded)"],
    ...
    ['input[name="pgsql_enabled"]', "Let your assistants inspect schemas and run read-only queries"],
    ...
    ['input[name="mobile_enabled"]', "Let your assistants drive mobile test devices"],
    ['input[name="aws_enabled"]', "Let your assistants reach AWS with these credentials"],
    ...
    ['input[name="jenkins_enabled"]', "Let your assistants trigger and read Jenkins jobs"],
    ...
    ["#connector-settings-form button[type=\"submit\"]", "Save this connector for all your assistants. Idle ones restart to pick it up; busy ones ask you to restart them."],
    ["[data-restart-agent-id]", "Restart this assistant now so it uses your latest connector settings"],

...
function renderDetails(agent) {
  ...
  primaryGroup.className = "stack action-group";
  const secondaryGroup = document.createElement("div");
  secondaryGroup.className = "stack action-group";
  if (isMine(agent)) {
    ...
    primaryGroup.append(startBtn, stopBtn);
    secondaryGroup.append(shareBtn, editBtn, deleteRuntimeBtn, destroyBtn);
    agentActions.append(primaryGroup, secondaryGroup);
  } else {
    ...
    primaryGroup.append(openBtn);
    agentActions.append(primaryGroup);
  }
}
...
topNewChatBtn?.addEventListener("click", () => { activeSessionId = null; clearChatMessages(); setChatStatus("New chat started"); });
topClearChatBtn?.addEventListener("click", clearChat);

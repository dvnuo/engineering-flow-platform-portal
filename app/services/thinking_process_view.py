...
def _build_thinking_event_display(event_type: str, data: dict) -> dict:
    ...
    by_type = {
        ...
        "chat.run.abort_failed": _display(icon="x-circle", title="Run Abort Failed", detail=data.get("error") or data.get("message") or "Chat run abort failed", kind="error"),
        ...
        "opencode.session.abort_failed": _display(icon="x-circle", title="OpenCode Session Abort Failed", detail=data.get("error") or data.get("message") or "OpenCode session abort failed", kind="error"),

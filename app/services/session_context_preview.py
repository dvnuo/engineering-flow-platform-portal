...
def _derive_source_preview(metadata: dict) -> dict:
    ...
    flat_preview = {
        ...
        "context_max_context_window_tokens": metadata.get("max_context_window_tokens"),
        "context_max_prompt_tokens": metadata.get("max_prompt_tokens"),
        "context_max_output_tokens": metadata.get("max_output_tokens"),
        "context_max_chat_output_tokens": metadata.get("max_chat_output_tokens"),
        "context_output_boundary_source": _normalize_preview_value(metadata.get("output_boundary_source")),
        "context_legacy_max_chat_output_chars_ignored": metadata.get("legacy_max_chat_output_chars_ignored"),
        "context_configured_max_chat_output_chars": metadata.get("configured_max_chat_output_chars"),
        "context_legacy_max_tokens_ignored": metadata.get("legacy_max_tokens_ignored"),
        "context_configured_max_tokens": metadata.get("configured_max_tokens"),
        "context_effective_max_tokens": metadata.get("effective_max_tokens"),
        "context_budget_max_chat_output_chars_ignored": metadata.get("budget_max_chat_output_chars_ignored"),
    ...
    nested_preview = {
        ...
        "context_max_context_window_tokens": source.get("max_context_window_tokens") if source.get("max_context_window_tokens") is not None else budget.get("max_context_window_tokens"),
        "context_max_prompt_tokens": source.get("max_prompt_tokens") if source.get("max_prompt_tokens") is not None else budget.get("max_prompt_tokens"),
        "context_max_output_tokens": source.get("max_output_tokens") if source.get("max_output_tokens") is not None else budget.get("max_output_tokens"),
        "context_max_chat_output_tokens": source.get("max_chat_output_tokens") if source.get("max_chat_output_tokens") is not None else budget.get("max_chat_output_tokens"),
        "context_output_boundary_source": _normalize_preview_value(source.get("output_boundary_source") or budget.get("output_boundary_source")),
        "context_legacy_max_chat_output_chars_ignored": source.get("legacy_max_chat_output_chars_ignored") if source.get("legacy_max_chat_output_chars_ignored") is not None else budget.get("legacy_max_chat_output_chars_ignored"),
        "context_configured_max_chat_output_chars": source.get("configured_max_chat_output_chars") if source.get("configured_max_chat_output_chars") is not None else budget.get("configured_max_chat_output_chars"),
        "context_legacy_max_tokens_ignored": source.get("legacy_max_tokens_ignored") if source.get("legacy_max_tokens_ignored") is not None else budget.get("legacy_max_tokens_ignored"),
        "context_configured_max_tokens": source.get("configured_max_tokens") if source.get("configured_max_tokens") is not None else budget.get("configured_max_tokens"),
        "context_effective_max_tokens": source.get("effective_max_tokens") if source.get("effective_max_tokens") is not None else budget.get("effective_max_tokens"),
        "context_budget_max_chat_output_chars_ignored": source.get("budget_max_chat_output_chars_ignored") if source.get("budget_max_chat_output_chars_ignored") is not None else budget.get("budget_max_chat_output_chars_ignored"),
    ...
    merged = {
        ...
        for key in (
            ...
            "context_max_context_window_tokens",
            "context_max_prompt_tokens",
            "context_max_output_tokens",
            "context_max_chat_output_tokens",
            "context_output_boundary_source",
            "context_legacy_max_chat_output_chars_ignored",
            "context_configured_max_chat_output_chars",
            "context_legacy_max_tokens_ignored",
            "context_configured_max_tokens",
            "context_effective_max_tokens",
            "context_budget_max_chat_output_chars_ignored",

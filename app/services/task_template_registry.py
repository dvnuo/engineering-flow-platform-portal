...
TASK_TEMPLATES: tuple[TaskTemplateDefinition, ...] = (
    ...
    TaskTemplateDefinition(
        ...
        optional_inputs=(
            ...
            "author", "author_association", "html_url", "path", "line", "side", "diff_hunk", "position", "commit_id", "commit_sha", "discussion_number", "discussion_id", "discussion_comment_id", "reply_to_id", "mentioned_logins", "notification_id", "notification_reason", "notification_subject_type", "notification_url", "notification_updated_at",
